...
export const jobs = pgTable("jobs", {
  ...
  tiktokPublishError: text("tiktok_publish_error"),
  tiktokPrivacyLevel: text("tiktok_privacy_level"),
  tiktokPostMode: text("tiktok_post_mode"),
  tiktokOpenId: text("tiktok_open_id"),
  tiktokCreatorUsername: text("tiktok_creator_username"),
  tiktokCreatorNickname: text("tiktok_creator_nickname"),
  tiktokAccessTokenFingerprint: text("tiktok_access_token_fingerprint"),
  tiktokInitResponse: jsonb("tiktok_init_response").$type<Record<string, unknown> | null>(),
  tiktokStatusResponse: jsonb("tiktok_status_response").$type<Record<string, unknown> | null>(),
  tiktokCreatorInfo: jsonb("tiktok_creator_info").$type<Record<string, unknown> | null>(),
